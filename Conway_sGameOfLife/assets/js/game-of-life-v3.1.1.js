    ...
    handlers : {
      ...
      buttons : {
        ...
        run : function() {
          ...
          if (GOL.running) {
            GOL.nextStep();
            document.getElementById('buttonRun').value = '停止';
          } else {
            document.getElementById('buttonRun').value = '运行';
          }
        },
         ...
         */
        trail : function() {
          GOL.element.messages.layout.innerHTML = GOL.trail.current ? '路径已关闭' : '路径已开启';
        ...
        colors : function() {
          ...
          GOL.element.messages.layout.innerHTML = '颜色主题#' + (GOL.colors.current + 1);
          if (GOL.running) {
        ...
        grid : function() {
          ...
          GOL.element.messages.layout.innerHTML = '网格主题#' + (GOL.grid.current + 1);
          if (GOL.running) {
